...
/*---------------------------------------------------------
 ...
 ---------------------------------------------------------*/
#define PHASE_ROTOR_ANGLE_30  (uint8_t)((uint8_t)21  )
#define PHASE_ROTOR_ANGLE_90  (uint8_t)((uint8_t)64  )
#define PHASE_ROTOR_ANGLE_150 (uint8_t)((uint8_t)107 )
#define PHASE_ROTOR_ANGLE_210 (uint8_t)((uint8_t)149 )
#define PHASE_ROTOR_ANGLE_270 (uint8_t)((uint8_t)192 )
#define PHASE_ROTOR_ANGLE_330 (uint8_t)((uint8_t)235 )
